...
const Slot = props => {
  ...
  if (props.role == "starter") {
    if (props.edit) {
      return (
        <li className={props.className}> {`${props.playerName} - ${props.currentCap}`}>
          <form>
      ...
      return (
        <li className= {props.className}>
          <span className="slot-data">
            ...
            <p className="slot-player"><a href={`/players/${props.playerId}`}>{props.playerName}</a> - #{props.number} {props.position} {props.nflTeam} - Bye Week: {props.byeWeek}   Salary: {props.currentCap}</p>
          </span>
        </li>
      )
    } else {
    ...
    if (props.edit) {
      return (
        <li className= {props.className}>
          <form>
            <p><a href={`/players/${props.playerId}`}>{props.playerName}</a> - #{props.number} {props.position} {props.nflTeam} - Bye Week: {props.byeWeek}  Salary: {props.currentCap}</p>
